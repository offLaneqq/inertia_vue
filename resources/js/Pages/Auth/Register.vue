...
const change = (e) => {
    form.avatar = e.srcElement.files[0]
        ...
        <form @submit.prevent="submit">
            ...
            <div class="grid place-items-center">
                <div class="relative w-28 h-28 rounded-full overflow-hidden border border-slate-300">
                    ...
                    <label for="avatar" class="absolute inset-0 grid content-end cursor-pointer"><span class="bg-white/70 pb-2 text-center">Avatar</span></label>
                    <input type="file" id="avatar" @input="change" hidden enctype="multipart/form-data">
